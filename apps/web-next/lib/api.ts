...
/**
 * Structured hub content stored in content_json for regional_hub / seasonal_hub / cluster_hub pages.
 * Generated by the hub agents and editable in /admin/cms. The hub pages render each field dynamically
 * and fall back to code defaults per field when a value is missing (Hybrid content model, 2026-08-04).
 */
export interface HubContent {
  intro?: string;
  overview?: string;
  why?: string;                                   // why trek here / why choose
...
export interface CMSPage {
  ...
  title: string;
  content_html: string;
  content_json: { sections?: TrekContentSections; trek_facts?: TrekFacts; faqs?: FAQItem[]; hub?: HubContent; [key: string]: unknown } | null;
  status: string;
