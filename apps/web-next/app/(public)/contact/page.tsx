...
export default async function Contact() {
  ...
  if (cms?.status === "published") {
    const schema = { "@context": "https://schema.org", "@type": "ContactPage", name: cms.title, description: cms.seo_description ?? "", url: `${SITE_URL}/contact`, publisher: { "@type": "Organization", name: "TrekYatra", url: SITE_URL } };
    return (
