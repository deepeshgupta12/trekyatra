          ...
          <table className="w-full text-sm min-w-[480px]">
            <thead>
              <tr className="border-b border-white/8">
                <th className="text-left px-4 py-3 text-white/40 font-medium text-xs">Keyword</th>
                <th className="text-left px-4 py-3 text-white/40 font-medium text-xs hidden sm:table-cell">Volume</th>
                <th className="text-left px-4 py-3 text-white/40 font-medium text-xs hidden sm:table-cell">Difficulty</th>
                <th className="text-left px-4 py-3 text-white/40 font-medium text-xs">Opportunity</th>
            ...
            <tbody>
              {[
                ...
                <tr key={t.keyword} className="border-b border-white/5 last:border-0 hover:bg-white/3 transition-colors">
                  <td className="px-4 py-3.5 text-white/80 font-medium text-xs sm:text-sm">{t.keyword}</td>
                  <td className="px-4 py-3.5 text-white/50 text-xs hidden sm:table-cell">{t.volume}</td>
                  <td className="px-4 py-3.5 text-white/50 text-xs hidden sm:table-cell">{t.difficulty}</td>
                  <td className="px-4 py-3.5">
                    <div className="flex items-center gap-2">
                      <div className="h-1.5 w-12 rounded-full bg-white/10 flex-shrink-0">
                  ...
                  <td className="px-4 py-3.5">
                    <span className={`text-xs font-medium px-2 py-1 rounded-full ${statusStyle[t.status]}`}>{t.status}</span>
                  </td>
