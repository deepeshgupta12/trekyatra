...
export function HtmlContentRenderer({ html }: Props) {
  ...
  // Editorial reading typography — oversized Playfair headings, generous whitespace
  // and body line-height so long guides/articles read like a native magazine, not a
  // cramped web page (the derived "Exaggerated Minimalism" direction).
  const tagsStyles = {
    h1: {
