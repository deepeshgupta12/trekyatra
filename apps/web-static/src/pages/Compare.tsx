...
const Compare = () => {
  const a = treks[0]; // Kedarkantha
  const b = treks[6]; // Brahmatal
  ...
  const rows = [
    ...
    ["Acclimatisation", "Comfortable", "Comfortable"],
    ["Summit views", "360° panorama", "Trishul-Nanda Ghunti up close"],
  ];
      ...
      <section className="bg-gradient-twilight text-surface py-16 relative overflow-hidden">
        <div className="container-wide">
          ...
          <p className="text-surface/80 text-lg max-w-2xl">
            Two of India's most popular winter snow treks. Both 6 days, both beginner-friendly, both Uttarakhand. Here's exactly which one to pick — and why.
          </p>
        </div>
      </section>
        ...
        <div className="container-wide">
          ...
          <div className="mt-10 p-8 md:p-10 rounded-2xl bg-gradient-pine text-surface grid md:grid-cols-[1fr_auto] gap-6 items-center">
            <div>
              ...
              <p className="text-surface/80">It's better supported, slightly cheaper, and has more flexibility on dates. Choose Brahmatal only if you've already done a snow trek and want fewer crowds.</p>
            </div>
