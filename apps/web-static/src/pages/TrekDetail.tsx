...
const TrekDetail = () => {
  ...
  const related = treks.filter(t => t.slug !== trek.slug).slice(0, 3);
    ...
    <SiteLayout>
      ...
      <section className="relative h-[78vh] min-h-[600px] flex items-end overflow-hidden">
        ...
        <div className="container-wide relative pb-12 text-surface">
          <Link to="/explore" className="text-xs uppercase tracking-widest text-accent-glow hover:text-accent mb-4 inline-block">
            ← Explore / {trek.state}
          </Link>
        ...
        <div className="container-wide grid lg:grid-cols-[200px_1fr_320px] gap-10">
          ...
          <article className="prose prose-lg max-w-none">
            <Block id="s0" eyebrow="Why this trek" title={`Why ${trek.name} is on every Indian trekker's list`}>
              <p>From the snowy summit's 360° view to the silent pine campsites at Juda Ka Talab, this trek delivers the full Himalayan experience in a beginner-friendly window. It's the perfect first taste of high-altitude trekking — challenging enough to feel earned, accessible enough to actually attempt.</p>
            ...
            <Block id="s1" eyebrow="Route overview" title="The 6-day route at a glance">
              <p>You start at Sankri (6,400 ft), climb gently through pine forest to Juda Ka Talab on day 2, ascend to the base camp on day 3, summit and descend on day 4, and trek back to Sankri across days 5–6. Total trekking distance: ~20 km.</p>
            </Block>

            <Block id="s2" eyebrow="Day-wise itinerary" title="What each day actually looks like">
              <div className="not-prose space-y-3">
                {[
                  { d: "Day 1", title: "Dehradun → Sankri", body: "210 km drive (10 hrs) along the Tons valley. Overnight in guesthouse." },
                  { d: "Day 2", title: "Sankri → Juda Ka Talab", body: "4 km trek through oak/pine forest. Arrive at frozen lake campsite. 9,100 ft." },
                  { d: "Day 3", title: "Juda Ka Talab → Base Camp", body: "4 km gentle climb to 11,250 ft. First panoramic mountain views." },
                  { d: "Day 4", title: "Summit Day", body: "Pre-dawn start. Steep snow climb to 12,500 ft. 360° Himalayan view. Descend to Hargaon." },
                  { d: "Day 5", title: "Hargaon → Sankri", body: "Long descent through forest. 6 km. Hot dinner in town." },
            ...
            <Block id="s3" eyebrow="Permits" title="What permits you need (and where to get them)">
              <div className="not-prose p-5 rounded-2xl bg-warning/10 border border-warning/30 flex gap-3 mb-4">
                <AlertTriangle className="h-5 w-5 text-warning flex-shrink-0 mt-0.5" />
                <div className="text-sm">Forest Department permits are mandatory and obtained by your trek operator at Sankri checkpost. Carry a Govt photo ID.</div>
              </div>
              <p>Solo trekking is technically allowed but discouraged. Expect a per-head Forest fee around ₹150 plus a small camping levy.</p>
            </Block>
            ...
            <Block id="s4" eyebrow="Cost estimate" title="What this trek will actually cost you">
              ...
              <p className="mt-4 text-sm text-muted-foreground">Excludes travel to Dehradun, gear rental, and personal expenses. <Link to="/costs" className="text-accent">Full cost breakdown →</Link></p>
            </Block>
            ...
            <Block id="s5" eyebrow="FAQs" title="Common questions answered">
              <div className="not-prose space-y-3">
                {[
                  ...
                  ["Do I need technical gear?", "Microspikes and gaiters are useful in peak winter. Operators usually provide these."],
                ].map(([q, a]) => (
          ...
          <aside className="hidden lg:block">
            <div className="sticky top-44 space-y-4">
              ...
              <div className="bg-card border border-border rounded-2xl p-6">
                ...
                <div className="space-y-2">
                  {[
                    ...
                    <Link key={to} to={to} className="flex items-center justify-between p-3 rounded-xl hover:bg-muted transition-colors">
              ...
              <div className="bg-accent/5 border border-accent/20 rounded-2xl p-6">
                <div className="text-xs uppercase tracking-widest text-accent mb-2">Trust & freshness</div>
                <div className="text-sm space-y-1.5">
                  <div className="flex justify-between"><span className="text-muted-foreground">Last updated</span><span className="font-medium">5 days ago</span></div>
                  <div className="flex justify-between"><span className="text-muted-foreground">Reviewed by</span><span className="font-medium">2 editors</span></div>
                  <div className="flex justify-between"><span className="text-muted-foreground">Permit verified</span><span className="font-medium text-success">✓ This week</span></div>
                </div>
              </div>
            </div>
          </aside>
...
const Block = ({ id, eyebrow, title, children }: { id: string; eyebrow: string; title: string; children: React.ReactNode }) => (
