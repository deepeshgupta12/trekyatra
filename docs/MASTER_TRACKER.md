...
| celery-worker deploy — FAILED: rediss:// needs ssl_cert_reqs=CERT_NONE | fixing — config.py update |
| config.py — _redis_ssl_params: ?ssl_cert_reqs=CERT_NONE appended to all rediss:// Celery URLs | done |
