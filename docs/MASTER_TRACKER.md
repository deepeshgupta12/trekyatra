...
| 56 | Weekly news agent + /news/[slug] pages — **Fixed 2026-05-26**: per-item architecture (one page/RSS article), slug from headline, TOC, admin tabs+filters+modal, trek-utils shared cmsPageToTrek | done |
